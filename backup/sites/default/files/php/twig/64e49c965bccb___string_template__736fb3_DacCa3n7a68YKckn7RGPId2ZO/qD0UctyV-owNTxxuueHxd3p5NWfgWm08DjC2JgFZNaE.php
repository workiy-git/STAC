...
class __TwigTemplate_6e5debc6d71e9d5ac45f337c4f96bcda extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("{# inline_template_start #}{{ release_version }} (<a href=\"{{ release_link }}\" title=\"{{ project_title }}\">{{ release_notes }}</a>)", "__string_template__736fb32267f0a5a6ecad463287d774ba", "");
    }
