...
/**
 * Provides formatter settings and theme rendering for below.
 *
 * All the Bootstrap Carousel entities and medias formatter.
 */
trait BootstrapCEFormatterTrait {

  /**
   * Helper function for default interval time set.
   *
  ...
  /**
   * Helper function for form to get interval time.
   *
  ...
  /**
   * Helper function to return summary.
   *
  ...
  /**
   * Helper function for carousal element view/display.
   *
